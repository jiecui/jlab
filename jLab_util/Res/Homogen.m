% HOMOGEN:  Measures the degree of homogeneity of a data matrix as:
%           (1) h: the complement of the mean clustering level from a UPGMA of 
%               1-abs(R), where R is the correlation matrix;
%           (2) m: the mean absolute correlation; and
%           (3) e: the proportion of variance accounted for the by PC1 of the
%               correlation matrix.
%
