function p = jlab_jlab_tcdf(x,v);
%jlab_tcdf   Student's T cumulative distribution function (cdf).
%   P = jlab_tcdf(X,V) computes the cdf for Student's T distribution
...
% Modified from the Matlab function of the same name.
