...
%           provided, reclassifies each observation into one of the known groups by
%           jackknifing the observations.
%
...
%           --------------------------------------------------------------------------
%           results = [n x k] matrix for the n "known" observations and k groups, or 
