...
function [d,s2d,ci,prob,holds] = propdiff(num1,den1,num2,den2,iter,ci_level)
  ...
  get_prob = 0;
  get_holds = 0;
  if (nargout >= 3) get_prob = 1; end;
  if (nargout >= 5) get_holds = 1; end;
