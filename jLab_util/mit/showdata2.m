...
%
% 3. You can see in the "current file info" window how many trials are in the data file
%
...
%
% 5. Now press "Plot Selected Trial(s)" and see what happens. If you did everything right, you should
%    get a nice 3D plot with different colored traces for each sensor. Also, the transmitter is displayed
%    at the (0, 0, 0) coordinate.
%
% 6. You can display several plots at once by pressing "Start New Figure" and specifying another plot.
%
% Have fun!
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'Callback','fig = figure(''number'',''off'',''name'',''Data Plot'');', ...
	'ListboxTop',0, ...
...
fig = figure('number','off','name','Data Plot');
num = 0;
name = '';
