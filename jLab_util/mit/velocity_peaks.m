function[peaks] = velocity_peaks(session, smoothing_factor, minimum_velocity, sensor_no)
%   EXAMPLE: peaks = velocity_peaks(session_info, 11, 5, 1)
%
% calculate the number of velocity peaks in each trial in a given session.
%
