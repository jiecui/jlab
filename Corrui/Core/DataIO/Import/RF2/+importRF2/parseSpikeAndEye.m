...
% $Revision: 0.5 $  $Date: 11/01/2011 10:57:16.624 AM $
% 
...
if time_len ~= x1_len
    ...
    if time_len < x1_len
        ...
        eye_x2 = eye_x2(1:time_len);
        eye_y2 = eye_y2(1:time_len);
...
if discard_chunk == true
    ...
    saedata.plainbar.plainbar_x     = plainbar_x;
    saedata.plainbar.plainbar_y     = plainbar_y;
    saedata.gratings.periodidx      = periodidx;
