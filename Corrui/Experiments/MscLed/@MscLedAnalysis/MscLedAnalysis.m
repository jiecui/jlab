classdef MscLedAnalysis < TuneAnalysis & EyeMovementAnalysis
    % Class MSCLEDANALYSIS Summary of this class goes here
    ...
    methods ( Static )
        ...
        % =======================
        result_dat = AggAnaMSTrigMldResp(current_tag, name, S, dat)
