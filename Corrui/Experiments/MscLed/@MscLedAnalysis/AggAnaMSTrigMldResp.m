function result_dat = AggAnaMSTrigMldResp(current_tag, name, S, dat)
% MSCLEDANALYSIS.AGGANAMSTRIGMLDRESP analyzes aggregated MSTriggeredMldResp
%
% Syntax:
%
% Input(s):
...
% Copyright 2013-2014 Richard J. Cui. Created: Tue 05/07/2013 10:19:30.351 PM
% $Revision: 0.3 $  $Date: Thu 07/17/2014  4:31:02.294 PM $
%
...
if strcmpi(current_tag,'get_big_vars_to_load')
    dat_var = { 'MSTriggeredMscledResp', 'sessions'};
...
ms_trig_resp = dat.MSTriggeredMscledResp;
