function trialnum = cyc_cond_2_trialnum(this, cycleidx, condidx)
...
NumberCondition = this.NumberCondition; % NumberCondition - number of conditons in one cycle
CondInCycle = this.CondInCycle;         % CondInCycle     - condition sequence in one cycle
