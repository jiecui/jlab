function result_dat = AggAnaMSTrig2ndPeak(current_tag, sname, S, dat)
% AGGANAMSTRIG2NDPEAK Analysis of 2nd peak of MS-triggered responses in aggregated session
% 
% Description:
...
%
% Syntax:
%   result_dat = AggUsaccTriggered2ndPeakAnalysis(current_tag, sname, S, dat)
% 
% Input(s):
%
% Output(s):
...
% $Revision: 0.2 $  $Date: Tue 04/29/2014 10:26:48.603 PM $
%
...
if strcmpi(current_tag,'get_options')
    ...
    opt.Max_average_response_options.pk_intv = {[150 200] 'Peak interval from MS-onset (ms)' [-1000, 1000]};
...
% commit results
% =========================================================================
result_dat.MSTrig2ndPeak.PeakMean = pk_mean;
result_dat.MSTrig2ndPeak.PeakSEM  = pk_err;
result_dat.MSTrig2ndPeak.RSquare  = gof.rsquare;
