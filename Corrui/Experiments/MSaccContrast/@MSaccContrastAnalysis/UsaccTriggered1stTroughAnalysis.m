function result_dat = UsaccTriggered1stTroughAnalysis(current_tag, name, S, dat)
% USACCTRIGGERED1STTROUGHANALYSIS Analysis of 1st trough of MS-triggered response of individual cell
% 
% Description:
%   This function analyzes the first trough after MS-onset of the
%   MS-triggered response.
% 
% Syntax:
%   result_dat = UsaccTriggered1stTroughAnalysis(current_tag, name, S, dat)
% 
% Input(s):
%
% Output(s):
...
% options and paras
% ------------------
spkdiff_flag = S.Stage_2_Options.UsaccTriggered1stTroughAnalysis_options.spkrate_diff;
intv_s1 = S.Stage_2_Options.UsaccTriggered1stTroughAnalysis_options.Spike_rate_diff_options.s1;
...
result_dat.UsaccTriggered1stTrough = Tmt1;
