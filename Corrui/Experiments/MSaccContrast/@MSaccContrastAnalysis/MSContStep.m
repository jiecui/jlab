function result_dat = MSContStep(current_tag, name, S, dat)
% MSACCCONTRASTANALYSIS.MSCONTSTEP Relationship between MS and Contrast steps 
% 
% Description:
%   This function analyzes the relationship between events of microsaccades
%   and events of contrast step change for individual cell
%
% Syntax:
% 
% Input(s):
