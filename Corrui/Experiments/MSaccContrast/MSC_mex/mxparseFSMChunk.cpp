...
*
* Copyright 2014 Richard J. Cui. Created: Wed 01/22/2014  2:16:22.546 PM
* $Revision: 0.2 $  $Date: Sat 03/22/2014  9:41:30.927 PM $
*
...
typedef struct fsmEnvVarsShort		// compatible with old exp; see savefixsim() in rf2fixsim.c
{
	...
	int32_t	activetime;			// time stamp when the bar/fix was set by the user in active mode
	int32_t	dataONtime;			// time stamp when the data was recorded
	int32_t	activetimestart;	// time stamp when the bar/fix was actaully moving
