function result_dat = AggResponseSortedAvg(current_tag, name, S, dat)
% AGGRESPONSESORTEDUSACCRATE analyzes the dynamics of microsaccades of the
%       trials sorted by response to contrast change.
%
% Syntax:
...
usa_halfwidth = S.Stage_2_Options.AggResponseSortedUsaccRate_options.Usacc_rate_smoothing_Window_half_width;
spk_halfwidth = S.Stage_2_Options.AggResponseSortedUsaccRate_options.Spike_rate_smoothing_Window_half_width;
