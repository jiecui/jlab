function [mn se] = AggUsaccTriggered1stTrough( curr_exp, sessionlist, S)
% AGGUSACCTRIGGERED1STTROUGH Assembles the results for 1st trough of MS-triggered response analysis
% 
% Syntax:
...
% $Revision: 0.1 $  $Date: Tue 03/05/2013  4:39:44.469 PM $
%
...
% =========================================================================
vars = {'UsaccTriggered1stTrough'};

SpikeRate = [];
SpikeRateDiff = [];
for k = 1:numSess
    data = CorruiDB.Getsessvars(sessionlist{k}, vars);
    spk_k = data.UsaccTriggered1stTrough.SpikeRate;
    spkdiff_k = data.UsaccTriggered1stTrough.SpikeRateDiff;
