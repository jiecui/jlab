function [mn se] = AggUsaccTriggered2ndPeak( curr_exp, sessionlist, S)
% AGGUSACCTRIGGERED2NDPEAK Assembles the results for 2nd peak of MS-triggered response analysis
% 
% Syntax:
...
% =========================================================================
vars = {'UsaccTriggered2ndPeak'};

SpikeRate = [];
SpikeRateDiff = [];
for k = 1:numSess
    data = CorruiDB.Getsessvars(sessionlist{k}, vars);
    spk_k = data.UsaccTriggered2ndPeak.SpikeRate;
    spkdiff_k = data.UsaccTriggered2ndPeak.SpikeRateDiff;
