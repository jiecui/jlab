function  [mn, se] = AggMSTrigBctResp( curr_exp, sessionlist, S)
% AGGMSTRIGBCTRESP Assembles the results of MSTriggeredBlankctrlResp
%
% Syntax:
%
% Input(s):
...
% $Revision: 0.2 $  $Date: Tue 09/30/2014 12:43:10.627 PM $
%
...
if numSess <= 3
    warning('AggMSTrigBctResp:NumberOfSessions', ...
...
S.Concatenate.options.MSTriggeredBlankctrlResp = true;
