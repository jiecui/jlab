...
enum = BCTUsacc.getEnum();

usacc_props = zeros( size(usac,1), BCTUsacc.usacc_props_size );

usacc_props(:,enum.start_index) = usac(:,enum.start_index);
usacc_props(:,enum.end_index)   = usac(:,enum.end_index);
usacc_props(:,enum.duration)    = BCTUsacc.getduration( usac , samplerate );
usacc_props(:,enum.magnitude)   = BCTUsacc.getmagnitude( eyedat, usac );
usacc_props(:,enum.magnitude2)  = BCTUsacc.getmagnitude2( eyedat, usac );
usacc_props(:,enum.pkvel)       = BCTUsacc.getpkvel( eyedat, usac );
usacc_props(:,enum.mnvel)       = BCTUsacc.getmnvel( eyedat, usac );
usacc_props(:,enum.direction)   = BCTUsacc.getdirection( eyedat, usac );
