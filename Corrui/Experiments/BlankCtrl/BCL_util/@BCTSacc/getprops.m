...
enum = BCTSacc.getEnum();

saccade_props = zeros( size(sac,1), BCTSacc.saccade_props_size );

saccade_props(:,enum.start_index) = sac(:,enum.start_index);
saccade_props(:,enum.end_index)   = sac(:,enum.end_index);
saccade_props(:,enum.duration)    = BCTSacc.getduration( sac , samplerate );
saccade_props(:,enum.magnitude)   = BCTSacc.getmagnitude( eyedat, sac );
saccade_props(:,enum.magnitude2)  = BCTSacc.getmagnitude2( eyedat, sac );
saccade_props(:,enum.pkvel)       = BCTSacc.getpkvel( eyedat, sac );
saccade_props(:,enum.mnvel)       = BCTSacc.getmnvel( eyedat, sac );
saccade_props(:,enum.direction)   = BCTSacc.getdirection( eyedat, sac );
