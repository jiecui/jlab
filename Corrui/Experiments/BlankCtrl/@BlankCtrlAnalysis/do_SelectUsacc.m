...
% DO_SELECTUSACC selects microsaccades for subsequent analysis 
%
% Syntax:
...
% Copyright 2013 Richard J. Cui. Created: Wed 04/24/2013 10:34:04.406 AM
% $Revision: 0.1 $  $Date: Wed 04/24/2013 10:34:04.406 AM $
%
...
% select usacc
% =========================================================================
MS = BCTUsacc(sname);    % construct usacc object
...
if strcmp(eye_choice, 'Left')
    ...
    selected_ms_props = selectMSSingleEye(ms_props, criteria, sname);
end % if
...
% subroutines
% =========================================================================
function sel_ms_props = selMSOnset(ms_props, onset_criteria, sname)

Trial = BCTTrial(sname);    % trial object
enum = Trial.enum;
...
function sel_ms_props = selectMSSingleEye(usacc_props, criteria, sname)
...
% ----------------------------
sel_ms_onset = selMSOnset(usacc_props, ms_onset, sname);
